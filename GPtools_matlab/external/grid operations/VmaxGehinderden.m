function [Volume Scale Fval exitflag]=VmaxGehinderden(Lden_grid, V0) 
...
%  Fval          (optioneel) verschil tussen aantal woningen en de gelijkwaardigheidsnorm
%  exitflag      (optioneel) zie help bij functie fzero; waarde 1 is covergentie
...
[Scale, Fval, exitflag] = fzero(@(multiplier) geschaaldeTellingenGehinderdenLden(multiplier,Lden_struct.dat,3),(530000/V0));
Volume = Scale * V0;
